...
class EdgeRemoval(Scene):
    def construct(self):
        ...
        self.play(Create(Title("Spanning Tree Generation")))
        self.play(Create(g))
        ...
        while verticesToVisit:
            ...
            for vertex in verticesToVisit:
                if vertex in visited:
                    ...
                    animations.append(g.animate.remove_edges(edgeToDelete))
                    animations.append(ShowPassingFlash(Line(g[edgeToDelete[1]], g[edgeToDelete[0]]).copy().set_color(RED), time_width=2.0, line_width=10))
            ...
            previouslyVisited = verticesToVisit
